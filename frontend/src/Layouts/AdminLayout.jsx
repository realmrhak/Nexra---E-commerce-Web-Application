...
import {
  LayoutDashboard, Package, PlusCircle, ShoppingCart, Tags,
  Users, Star, Settings, LogOut, Menu, X, Store, Sun, Moon, ArrowLeft,
} from 'lucide-react';
    ...
    <div className="adminLayout">
      ...
      <aside className={`adminSidebar ${sidebarOpen ? 'open' : ''}`}>
        <div className="adminBrand">
          <Store size={22} />
          <span>Ne<span className="brand-x">x</span>ra</span>
        </div>
